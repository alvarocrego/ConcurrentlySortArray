 ...
 * ordenacion: Insercion Directa, Quick Sort y Merge Sort. Proporciona ademas un
 * metodo para comprobar si dos arrays genericos son iguales.
 *
...
public class Ordenacion {
     ...
     * @param f, extremo superior del intervalo a ordenar PRECONDICION: i<=f
     */
